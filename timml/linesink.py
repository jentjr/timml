...
class LineSinkBase(LineSinkChangeTrace, Element):
    ...
    def disvecinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            ...
            qxqy[:, :] = besselaesnew.disbeslsho(
                x, y, self.z1, self.z2, aq.lab, 0, aq.ilap
            )
...
class LineSinkHoBase(LineSinkChangeTrace, Element):
    ...
    def initialize(self):
        ...
        self.strengthinf = strengthinf_controlpoints(
            self.ncp, self.nlayers
    ...
    def potinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            ...
            pot[:, :] = besselaesnew.potbeslsv(
                x, y, self.z1, self.z2, aq.lab, self.order, aq.ilap
            )
...
class LineSinkStringBase(Element):
    ...
    def changetrace(
        ...
        xyztnew = 0
        for ls in self.lslist:
            changed, terminate, xyztnew = ls.changetrace(
